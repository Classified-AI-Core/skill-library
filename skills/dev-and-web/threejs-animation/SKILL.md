...
## Related Skills
- **nano-banana-2** — generate AI sprites, textures, and visual assets for Three.js scenes
- **remotion-best-practices** — combine Three.js animations with Remotion for rendered video output
