---
name: cut-video
description: Tighten a long recording — remove silences, fillers, mistakes, and dead air while preserving laughs and
  comedic pauses. Use when the user pastes a video and says "cut this", "tighten this video", "remove silences", "strip
  ums", "clean this up", or any variant of "make this video shorter without losing the good parts". Fast (proxy +
  hardware decode + trim/concat) — runs in seconds, not minutes, on M-series Macs.
metadata:
